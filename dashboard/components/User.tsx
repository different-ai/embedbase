...
export function User() {
  ...
  return (
    <Menu as="div" className="relative inline-block px-3 text-left">
      ...
      >
        <Menu.Items className="bottom-[45px] absolute right-0 left-0 z-10 mx-3 mt-1 origin-bottom divide-y divide-gray-200 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
                <Link
