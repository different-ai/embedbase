import { SupabaseClient, createServerComponentSupabaseClient } from '@supabase/auth-helpers-nextjs';
...
export default async function Index(ctx) {
    ...
    let datasetName = ''
    try {
        const { documents: d, datasetName: n, datasetOwner, count: c } = await getDocuments(supabase, datasetId, {
            from,
            to,
        })
        datasetName = n
