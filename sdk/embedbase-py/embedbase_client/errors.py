class EmbedbaseAPIException(Exception):
    """
    A generic exception for the Embedbase API.
    """
    ...
    # the raw message returned by Embedbase's API. This was previously available
