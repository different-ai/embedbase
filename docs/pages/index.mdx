...
| Section | Description |
|-|-|
| [SDKs documentation](https://docs.embedbase.xyz/sdk) | The Embedbase Javascript SDK |
| [Self-hosting quick tour](https://docs.embedbase.xyz/self-hosting/quick-tour) | Run embedbase locally in Python |
