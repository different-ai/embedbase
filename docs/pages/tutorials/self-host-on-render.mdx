...
Make sure to have sat up Supabase for Embedbase to work. You can find the instructions [here](https://docs.embedbase.xyz/self-hosting/deployment#using-supabase).
